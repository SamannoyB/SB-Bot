...
**Important Note**: Please Edit the file 'package.json'. Change it from demo-user to your dev name.

**Programs**: Please Ensure That Discord Is Deployed To The Autocode Project With A Prefix Env Variable. Make changes in the source code wherever you like.

# Original README Of Autocode
